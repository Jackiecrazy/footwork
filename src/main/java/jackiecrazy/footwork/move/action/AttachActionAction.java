...
public class AttachActionAction extends Action {
    ...
    public int perform(ActionContext actionContext) {
        ...
        ActionData.getCap(recipient.resolve(actionContext)).mark(performer.resolve(actionContext), new ActionSetWrapper(effect_list).setNamespace(rl).appendContext(actionContext));
        return 0;
    }
}
