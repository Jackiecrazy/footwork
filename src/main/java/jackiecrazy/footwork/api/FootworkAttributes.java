...
public class FootworkAttributes {
    ...
    public static final RegistryObject<Attribute> MAX_FRACTURE = ATTRIBUTES.register("max_fracture", () -> new RangedAttribute(Footwork.MODID + ".maxFracture", 3, 1, Double.MAX_VALUE).setSyncable(true));
    public static final RegistryObject<Attribute> MAX_POSTURE = ATTRIBUTES.register("max_posture", () -> new RangedAttribute(Footwork.MODID + ".maxPosture", 10d, 0, Double.MAX_VALUE));
